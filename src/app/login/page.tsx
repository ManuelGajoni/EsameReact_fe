        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-gray-200 hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-xl transition-colors text-sm"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-gray-900 hover:bg-gray-800 text-white font-medium py-3 rounded-xl transition-colors text-sm"
            >
          ...
          <div className="mt-5 p-3 bg-amber-50 border border-amber-100 rounded-xl">
            ...
            <p className="text-xs text-amber-600">marco@fields.it · password123</p>
          </div>
        </div>
      </div>
    </div>
